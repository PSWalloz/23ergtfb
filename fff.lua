...
--! configuration
local service = 979;  -- your service id, this is used to identify your service.
local secret = "35a22097-2f2f-4ebc-b084-88a0688c0c33";  -- make sure to obfuscate this if you want to ensure security.
...
local windowVisible = false-- Start with the window visible

UserInputService.InputBegan:Connect(function(input, gameProcessed)
    -- If Insert key is pressed and not a game input
    if not gameProcessed and input.KeyCode == Enum.KeyCode.Insert then
        windowVisible = not windowVisible
        Window:SetVisible(windowVisible)  -- Toggle visibility
    end
end)
